...
- **默认窗口**：1680×1200（按主屏工作区 clamp：宽 ≤1680 且 ≤工作区宽−400，高 ≤1200 且 ≤工作区高−80），主屏工作区居中；**不使用窗口状态持久化**，故每次启动尺寸/位置一致，便于测试对比。CDP overlay 各自钉住尺寸（默认 overlay 1680×1200、窄窗 overlay 900×750）。
